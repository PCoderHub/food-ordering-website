...
function Cart() {
  ...
  return (
    <div className='container w-1/2 h-[80vh] mx-auto p-1 my-4 mt-10 border rounded-md'>
      ...
      <button className={`text-center w-1/2 mb-5 p-1 px-2 my-2 border rounded-full ${cartItems.length > 0 ? "bg-sky-500 text-white" : "bg-gray-300 text-gray-500"}`}>Go to Checkout</button>
      </div>
    </div>
  )
}
