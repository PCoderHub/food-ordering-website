...
function MenuItem() {
  ...
  const cat = foodCategories.filter(
    (category) => parseInt(itemId[0]) === category.id
  )[0].name;
  ...
  return (
    <div className="container w-1/2 h-[80vh] mx-auto p-1 my-4 mt-10 border rounded-md">
      ...
      <div className="p-2 flex flex-col items-center">
        ...
        <button
          className="p-1 px-2 my-2 bg-sky-500 border rounded-full text-white hover:bg-sky-600"
          onClick={addToCart}
        >
          Add to Cart
        </button>
